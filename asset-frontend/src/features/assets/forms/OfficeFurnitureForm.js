...
export default function OfficeFurnitureForm() {
	const { id } = useParams();
	...
	return (
		<form className={styles.form} onSubmit={submit}>
			<div className={styles.formHeader}>
				<h3>{id ? 'Edit Office Furniture' : 'Add Office Furniture'}</h3>
				<p className={styles.categoryTag}>🪑 Office Furniture</p>
			</div>
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., Herman Miller Aeron, IKEA BEKANT"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., HR-2024-001 (optional)"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., Office A, Floor 3, Desk Area 1"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., John Doe (optional - shared furniture)"
			...
			<div className={styles.formGroup}>
				...
				<textarea
					placeholder="e.g., Good condition, minor surface scratch on left side"
					value={model.remarks}
			...
			<div className={styles.buttonGroup}>
				<button type="submit" className={styles.submitBtn}>{id ? 'Update Furniture' : 'Add Furniture'}</button>
