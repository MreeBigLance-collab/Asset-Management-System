	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.controls}>
				...
				/>
				<Link to={`/assets/new?category=${categoryId}`} className={styles.addBtn}>+ Add Asset</Link>
			</div>
			...
			<div className={styles.tableWrapper}>
				{assets.length === 0 ? (
					<div className={styles.noData}>
						<p>📦 No assets found</p>
						<Link to={`/assets/new?category=${categoryId}`} className={styles.addBtnSmall}>Add First Asset</Link>
					</div>
				) : (
