...
export default function SecurityFacilitiesForm() {
	const { id } = useParams();
	...
	useEffect(() => {
		api.getSubcategories(4).then(result => {
			setSubs(result);
			if (result.length > 0 && !model.subcategoryId) {
				setModel(prev => ({
					...prev,
	...
	return (
		<form className={styles.form} onSubmit={submit}>
			<div className={styles.formHeader}>
				<h3>{id ? 'Edit Security & Facilities' : 'Add Security & Facilities'}</h3>
				<p className={styles.categoryTag}>🔒 Security & Facilities</p>
			</div>
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., Hikvision DS-2245, Daikin FTV30"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., SN456789 (optional)"
			...
			<div className={styles.formGroup}>
				<label>Installation Cost (RM) *</label>
				<input
					type="number"
					step="0.01"
					placeholder="0.00"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., Main Entrance, Server Room, Reception"
			...
			<div className={styles.formGroup}>
				...
				<input
					type="text"
					placeholder="e.g., Security Manager, Facilities Officer (optional)"
			...
			<div className={styles.formGroup}>
				<label>Maintenance / Service Notes</label>
				<textarea
					placeholder="e.g., Last service: 01/02/2026, Next service: 01/08/2026, Maintenance contract: ABC123"
					value={model.remarks}
			...
			<div className={styles.buttonGroup}>
				<button type="submit" className={styles.submitBtn}>{id ? 'Update System' : 'Add System'}</button>
